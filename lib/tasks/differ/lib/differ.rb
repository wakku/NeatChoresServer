require './lib/tasks/differ/lib/differ/change'
require './lib/tasks/differ/lib/differ/diff'
require './lib/tasks/differ/lib/differ/format/ascii'
require './lib/tasks/differ/lib/differ/format/color'
require './lib/tasks/differ/lib/differ/format/html'
