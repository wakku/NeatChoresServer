  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested item" do
        ...
        Item.any_instance.should_receive(:update_attributes).with({ "description" => "MyString" })
        put :update, {:id => item.to_param, :item => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the item as @item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Item.any_instance.stub(:save).and_return(false)
        put :update, {:id => item.to_param, :item => { "description" => "invalid value" }}, valid_session
        assigns(:item).should eq(item)
      end
